...
#define LCD_BASE    ((uint32_t)(0x60000000 | 0x007ffffe))
...
void LCD_Color_Fill(uint16_t sx,uint16_t sy,uint16_t ex,uint16_t ey,const uint16_t *color);           //填充指定颜色
...
void LCD_WriteRAM(__IO uint16_t RGB_Code);
